...
if __name__ == "__main__":
    ...
    print ('\n')
    print ('[1, 0, 0, 0] ---> ', b.get_assoc([1, 0, 0, 0]))
    print ('[1, 1, 0, 0] ---> ', b.get_assoc([1, 1, 0, 0]))
    print ('[0, 0, 0, 1] ---> ', b.get_assoc([0, 0, 0, 1]))
    print ('[0, 0, 1, 1] ---> ', b.get_assoc([0, 0, 1, 1]))
    print ('---')
    print ('[0, 1, 0, 0] ---> ', b.get_assoc([0, 1, 0, 0]))
    print ('[0, 1, 1, 0] ---> ', b.get_assoc([0, 1, 1, 0]))
